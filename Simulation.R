...
AICMETHOD <- function(TuneGrid, Iteration){
  ...
  for (i in 1:Iteration)
  {
    ...
    if(TuneGrid$method ==1){
      data = Gen_Method1(n_s.1,n_s.2,n_s.3,P=p,N=n,co=0.8)
    }else{
